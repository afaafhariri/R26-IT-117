"""
Train an XGBoost model for residential construction timeline prediction.

This script uses MultiOutputRegressor with XGBRegressor so one training run can
predict all phase durations and total project duration.
"""
...
MODEL_PATH = MODELS_DIR / "timeline_xgboost_model.pkl"
...
def main() -> None:
    """Load dataset, train XGBoost, evaluate, and save model package."""
    ...
    print("Training XGBoost timeline model...")
